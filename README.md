...
| Onboarding video kills browser process | Pre-seed both `Local State` and `Preferences` with onboarding marked complete |
| Updater crashes in background | `--disable-background-networking` silences it |
